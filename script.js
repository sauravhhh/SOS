document.addEventListener('DOMContentLoaded', function() {
    ...
    function sendSMSWithLocation() {
        // Create message with location
        const message = `EMERGENCY SOS ALERT!\n\nI need help! This is an emergency alert.\n\nMy Location:\nLatitude: ${userLocation.lat}\nLongitude: ${userLocation.lon}\nAccuracy: ${Math.round(userLocation.accuracy)}m\n\nMap: https://maps.google.com/?q=${userLocation.lat},${userLocation.lon}\n\nTime: ${new Date().toLocaleString('en-IN')}\nBattery: ${document.getElementById('batteryText').textContent.replace('Battery: ', '')}\nIP: ${document.getElementById('ipText').textContent.replace('IP Address: ', '')}`;
        ...
        statusMessage.textContent = "Emergency alert prepared! Please send the SMS.";
        statusMessage.classList.add('success');
        
        console.log("SOS Alert Sent with location!");
    }
    
    // Function to send SMS without location
    function sendSMSWithoutLocation() {
        ...
        console.log("SOS Alert Sent without location!");
    }
